  ...
  return (
    <View style={{ flex: 1 }}>
      <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={{ paddingBottom: isLandscape ? 76 : 100 }}>
        ...
        <TouchableOpacity
          style={[styles.actionCard, { backgroundColor: colors.primarySurface || colors.surface, borderColor: colors.primary }]}
          onPress={tour.start}
          activeOpacity={0.7}
        >
          <Text style={styles.actionIcon}>🎓</Text>
          <Text style={[styles.actionTitle, { color: colors.primary }]}>Start Guided Tour</Text>
